...
export const imageModels: ModelInfo[] = [
  {
    ...
    price: parseFloat(process.env.PRICE_IMAGE_GPT || '0.038'),
    type: 'image',
  },
  {
    id: 'ideogram',
    ...
    price: parseFloat(process.env.PRICE_IMAGE_IDEOGRAM || '0.073'),
    type: 'image',
  },
  {
    id: 'qwen',
    ...
    price: parseFloat(process.env.PRICE_IMAGE_QWEN || '0.027'),
    type: 'image',
  },
];
...
export const videoModels: ModelInfo[] = [
  {
    ...
    price: parseFloat(process.env.PRICE_VIDEO_SORA_2 || '0.231'),
    type: 'video',
  },
  {
    id: 'veo-3.1',
